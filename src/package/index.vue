<template>
    <div v-loading="isView" class="flow-containers" :class="{ 'view-mode': isView }">
        <el-container style="height: 100%">
            <el-header style="border-bottom: 1px solid #00e9ff;height: auto;">
            ...
            <el-container style="align-items: stretch" class="cav-container">
                <el-main style="padding: 0;" @mousewheel.prevent>
...
.flow-containers {
    ...
    //     fill: #2b7a93 !important;
    //     stroke: #2b7a93 !important;
    // 	 marker-end: url('#sequenceflow-arrow-norma'l)!important;
    //   }
